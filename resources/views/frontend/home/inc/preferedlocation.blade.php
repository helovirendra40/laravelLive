                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="responsive">                                            
                                    <div class="col-md-2">
                                        <div class="slidecl">
                                            <div class="slidec width-100"><a href=""><img src="{{asset('assets/frontend/images/location/Kolkata.png')}}" alt=""><div class="firstslide">KOLKATA</div></a></div>
                                            <div class="slidec width-100"><img src="{{asset('assets/frontend/images/location/Mumbai.png')}}" alt=""> <div class="firstslide">MUMBAI</div></div>
                                        </div>                                                
                                    </div>
                                    <div class="col-md-2">
                                        <div class="slidecl">
                                            <div class="slidec width-100"><img src="{{asset('assets/frontend/images/location/Ahmedabad.png')}}"alt=""><div class="firstslide">AHMEDABAD</div></div>
                                            <div class="slidec width-100"><img src="{{asset('assets/frontend/images/location/Bangalore.png')}}" alt=""><div class="firstslide">BANGALORE</div></div>
                                        </div>                                                
                                    </div>
                                    <div class="col-md-2">
                                        <div class="slidecl">
